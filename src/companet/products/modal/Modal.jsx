...
const Modal = () => {
    ...
    return (
        <AnimatePresence>
            <motion.div
                className="border border-gray-200 text-white rounded w-[270px]  h-[45px] bg-white z-50 absolute ml-[690px] "
                ...
                <div className="flex items-center gap-7 py-[8px] px-[40px] cursor-pointer" onClick={toggleAccordion}>
                    ...
                    <h2 className="text-[15px] font-semibold text-black">По умолчанию</h2>

                    <svg className={`h-6 w-6 text-black transition-transform transform ${isOpen ? 'rotate-10' : 'rotate-0'}`}
                         fill="none"
                         stroke="currentColor">
